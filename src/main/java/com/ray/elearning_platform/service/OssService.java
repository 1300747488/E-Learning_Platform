...
public interface OssService {
     ...
     * @return 上传结果，后续实现时返回 OssUploadResp，包含 objectKey、fileUrl、fileSize 等信息
     */
    JsonData upload(MultipartFile file, String bizType, Integer uploaderId);
     ...
     * @return 删除结果
     */
    JsonData delete(String objectKey);

    /**
     * 获取 OSS 文件访问地址。
     *
     * @param objectKey OSS 对象Key，必填
     * @return 文件访问地址，后续实现时可返回 String 或 OssUploadResp
     */
    JsonData getFileUrl(String objectKey);
}
